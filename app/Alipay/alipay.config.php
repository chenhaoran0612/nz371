...
$alipay_config['partner']		= '2088821715221038';

// MD5密钥，安全检验码，由数字和字母组成的32位字符串，查看地址：https://globalprod.alipay.com/order/myOrder.htm, see key
$alipay_config['key']			= 'hxonc22a8os90vgvjfk7uic7o7x5w9jp';

// 服务器异步通知页面路径  需http(s)://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
$alipay_config['notify_url'] = "https://www.kirin2.com/alipay/notify_url";
