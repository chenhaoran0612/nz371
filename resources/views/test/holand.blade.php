        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    ...
                    <p style="text-align: center;padding: 10px;font-weight: 10px;color: red">你将参与测试的这个《职业兴趣倾向测验》，可以帮助你做一次简单的兴趣测评，从而更加清楚自己的兴趣特征适合。请根据对每一题目的第一印象作答，不必仔细推敲，答案没有好坏、对错之分。根据自己的实际情况回答(符合你的情况请在题干前面的方框内打勾)</p>
