    ...
    <div id="outer-container">
      ...
      <section id="main-content" class="clearfix">
        ...
        <article id="{{$category->id}}" class="section-wrapper clearfix" data-custom-background-img="/imgs/bg{{$category->id % 7 + 1}}.jpg">
          <div class="content-wrapper clearfix wow fadeInDown animated" data-wow-delay="0.3s" style="position: absolute; visibility: visible; animation-delay: 0.3s; animation-name: fadeInDown;top: 0;">
