    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">新增/编辑Banner</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="panel-body">
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in" id="basic">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">序号 <span class="text-danger">*</span></label>
                                                <input type="text" id="index" name="index" class="form-control" value="{{$banner ? $banner->index : ''}}" >
                                            </div>
                                        </div>
...
@section('extend_js')
    ...
    <script type="text/javascript">
        ...
        $('.banner_submit').click(function(){
            var images = getSingleUploadImage('banner-images');
